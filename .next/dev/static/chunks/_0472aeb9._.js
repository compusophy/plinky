                    ...
                    for (const pair of event.pairs){
                        ...
                        const handleSettled = {
                            "PlinkoBoard.useEffect.collisionHandler.handleSettled": (binIndex)=>{
                                ...
                                setBalls({
                                    "PlinkoBoard.useEffect.collisionHandler.handleSettled": (prev)=>{
                                        const updated = {
                                            ...prev
                                        };
...
_s(PlinkoBoard, "HhZ4BLERqtp/XZzX/AmrkuS/fA8=");
_c = PlinkoBoard;
...
const App = ()=>{
    ...
    const [multipliers, setMultipliers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CALIBRATED_MULTIPLIERS"].length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CALIBRATED_MULTIPLIERS"] : __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MULTIPLIERS"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$farcaster$2b$miniapp$2d$sdk$40$0$2e$2$2e$1_typescript$40$5$2e$8$2e$3$2f$node_modules$2f40$farcaster$2f$miniapp$2d$sdk$2f$dist$2f$sdk$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sdk"].actions.ready().catch({
                "App.useEffect": (error)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "App.useEffect": ()=>{
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CALIBRATED_MULTIPLIERS"].length > 0) {
                console.log('Using pre-calibrated multipliers:', __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CALIBRATED_MULTIPLIERS"]);
                return;
            }
            // Otherwise, apply initial calibration from base multipliers
            const baseEV = calculateExpectedValue(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MULTIPLIERS"]);
            if (baseEV > 0) {
                ...
                const finalScalingFactor = targetRTPFactor * __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PHYSICS_CALIBRATION_COEFFICIENT"];
                const newMultipliers = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MULTIPLIERS"].map({
                    "App.useEffect.newMultipliers": (m)=>parseFloat((m * finalScalingFactor).toPrecision(3))
                }["App.useEffect.newMultipliers"]);
                setMultipliers(newMultipliers);
                console.log('Auto-calibrated multipliers (dev mode):', {
                    baseEV: baseEV.toFixed(4),
                    targetRTPFactor: targetRTPFactor.toFixed(4),
                    physicsCoeff: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PHYSICS_CALIBRATION_COEFFICIENT"],
    ...
    }["App.useEffect"], []); // Only run once on mount
    ...
    const calibrateFromActualData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[calibrateFromActualData]": ()=>{
            ...
            if (gamesSinceLastCalibration < 50) {
                ...
                setTimeout({
                    "App.useCallback[calibrateFromActualData]": ()=>setNotification(null)
                }["App.useCallback[calibrateFromActualData]"], 5000);
                return;
            }
            // Calculate actual probability distribution from ALL cumulative games
            const actualProbs = [];
            const totalWins = binDistributionRef.current.reduce({
                "App.useCallback[calibrateFromActualData].totalWins": (a, b)=>a + b
            }["App.useCallback[calibrateFromActualData].totalWins"], 0);
            ...
            const calibratedMultipliers = multipliers.map({
                "App.useCallback[calibrateFromActualData].calibratedMultipliers": (m)=>parseFloat((m * adjustmentFactor).toPrecision(3))
            }["App.useCallback[calibrateFromActualData].calibratedMultipliers"]);
            ...
            setTimeout({
                "App.useCallback[calibrateFromActualData]": ()=>setNotification(null)
            }["App.useCallback[calibrateFromActualData]"], 8000);
        }
    }["App.useCallback[calibrateFromActualData]"], [
        multipliers,
        targetRTP
    ...
    const forceCalibrate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[forceCalibrate]": ()=>{
            const totalGames = totalGamesPlayedRef.current;
            if (totalGames < 50) {
                setNotification({
                ...
                setTimeout({
                    "App.useCallback[forceCalibrate]": ()=>setNotification(null)
                }["App.useCallback[forceCalibrate]"], 5000);
                return;
            }
            const actualProbs = [];
            const totalWins = binDistributionRef.current.reduce({
                "App.useCallback[forceCalibrate].totalWins": (a, b)=>a + b
            }["App.useCallback[forceCalibrate].totalWins"], 0);
            if (totalGames === 0 || totalWins === 0) {
                setNotification({
                    message: 'Cannot calibrate: no wins recorded.',
                    type: 'error'
            ...
            const calibratedMultipliers = multipliers.map({
                "App.useCallback[forceCalibrate].calibratedMultipliers": (m)=>parseFloat((m * scaleFactor).toPrecision(3))
            }["App.useCallback[forceCalibrate].calibratedMultipliers"]);
            setMultipliers(calibratedMultipliers);
            lastCalibrationGamesRef.current = totalGames;
            setNotification({
            ...
            setTimeout({
                "App.useCallback[forceCalibrate]": ()=>setNotification(null)
            }["App.useCallback[forceCalibrate]"], 8000);
        }
    }["App.useCallback[forceCalibrate]"], [
        multipliers,
        targetRTP
    ...
    const exportCalibratedMultipliers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[exportCalibratedMultipliers]": ()=>{
            const multiplierString = multipliers.map({
                "App.useCallback[exportCalibratedMultipliers].multiplierString": (m)=>m.toFixed(3)
            }["App.useCallback[exportCalibratedMultipliers].multiplierString"]).join(', ');
            ...
            navigator.clipboard.writeText(codeToCopy).then({
                "App.useCallback[exportCalibratedMultipliers]": ()=>{
                    ...
                    setTimeout({
                        "App.useCallback[exportCalibratedMultipliers]": ()=>setNotification(null)
                    }["App.useCallback[exportCalibratedMultipliers]"], 12000);
                }
            }["App.useCallback[exportCalibratedMultipliers]"]).catch({
                "App.useCallback[exportCalibratedMultipliers]": ()=>{
                    ...
                    setTimeout({
                        "App.useCallback[exportCalibratedMultipliers]": ()=>setNotification(null)
                    }["App.useCallback[exportCalibratedMultipliers]"], 15000);
                }
            }["App.useCallback[exportCalibratedMultipliers]"]);
        }
    }["App.useCallback[exportCalibratedMultipliers]"], [
    ...
    const handleSimulate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "App.useCallback[handleSimulate]": async ()=>{
            ...
            const totalPayout = simulationPayouts.reduce({
                "App.useCallback[handleSimulate].totalPayout": (sum, payout)=>sum + payout
            }["App.useCallback[handleSimulate].totalPayout"], 0);
            ...
            binIndices.forEach({
                "App.useCallback[handleSimulate]": (binIdx)=>{
                    binCounts[binIdx]++;
                }
            ...
            binCounts.forEach({
                "App.useCallback[handleSimulate]": (count, i)=>{
            ...
            if (totalGamesPlayed >= 50 && actualHistoryRTP !== null) {
                ...
                const actualProbs = [];
                const totalWins = binDistributionRef.current.reduce({
                    "App.useCallback[handleSimulate].totalWins": (a, b)=>a + b
                }["App.useCallback[handleSimulate].totalWins"], 0);
                for(let i = 0; i < multipliers.length; i++){
                ...
                if (calibrationHistoryRef.current.length > 0) {
                    ...
                    calibrationHistoryRef.current.slice(-5).forEach({
                        "App.useCallback[handleSimulate]": (cal, idx)=>{
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CALIBRATED_MULTIPLIERS"].length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(App, "v4s+5dswZvl1F5B/8SxAw47JUiw=");
_c = App;
